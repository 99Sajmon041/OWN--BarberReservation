...
public sealed class GetAdminHairdresserServiceByIdQueryHandler(
    ILogger<GetAdminHairdresserServiceByIdQueryHandler> logger,
    IUnitOfWork unitOfWork,
    IMapper mapper) : IRequestHandler<GetAdminHairdresserServiceByIdQuery, HairdresserServiceDto>
{
    public async Task<HairdresserServiceDto> Handle(GetAdminHairdresserServiceByIdQuery request, CancellationToken ct)
    {
