...
public sealed class GetLookUpHairdressersByServiceQueryHandler(
    ...
    IMapper mapper,
    IUnitOfWork unitOfWork) : IRequestHandler<GetLookUpHairdressersByServiceQuery, IReadOnlyList<Shared.Models.LookUpModels.LookUpHairdressersDto>>
{
    public async Task<IReadOnlyList<Shared.Models.LookUpModels.LookUpHairdressersDto>> Handle(GetLookUpHairdressersByServiceQuery request, CancellationToken ct)
    {
        ...
        var hairdressersDto = mapper.Map<List<Shared.Models.LookUpModels.LookUpHairdressersDto>>(hairdressers);
