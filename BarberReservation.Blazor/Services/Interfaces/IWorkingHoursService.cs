...
public interface IWorkingHoursService
{
    ...
    Task<List<WorkingHoursDto>> GetWorkingHoursByWeek(string hairdresserId, DateOnly monday, CancellationToken ct);
    Task<bool> ExistsWorkingHoursAsync(CancellationToken ct);
}
